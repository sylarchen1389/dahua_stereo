...
static bool setLineTriggerConf(IAcquisitionControlPtr sptrAcquisitionCtl)
{
	// 设置触发源为Line1触发
	// set trigger source to Line1 trigger
	...
	// set external trigger as rising edge (falling edge as falling edge)
